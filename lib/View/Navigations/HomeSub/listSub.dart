...
class _SubListPageState extends State<SubListPage> {
  ...
  bookmarkDelete() async {
    var response =
        await http.delete(url + "/api/bookmarks?user_id=59&place_id=$place_id");
...
*/
    ...
    SpinKitThreeBounce buildSpinKitThreeBounce(
        double size, double screenWidth) {
        ...
        child: SafeArea(
          child: Scaffold(
            ...
            body: ListView(
              ...
              physics:
                  enabled ? NeverScrollableScrollPhysics() : ScrollPhysics(),
              children: [
                Column(
